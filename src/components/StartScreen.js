...
//   const startGame = () => {
//     // Navigate to the game page and pass selected options as state
//     navigate('/game', {
//       state: {
//         theme: selectedTheme,
...
//     <StartScreenWrapper>
//       <LogoWrapper>
//         <WhiteLogo src={logoSvg} alt="Logo" />
//       </LogoWrapper>
//       <OptionBoxContainer>
//         <OptionBox>
...
//         </OptionBox>
//         <ButtonWrapper>
//         <CustomButton aria-label="Start Game" $text="Start Game"  $backgroundColor="var(--color-orange)" $textColor="var(--color-background-page)" $textcolorhover="var(--color-background-page)" $backgroundColorHover="var(--color-orange-hover)" onClick={startGame}/>
//         </ButtonWrapper>
//         </OptionBoxContainer>
//     </StartScreenWrapper>
//   );
